...
```bash
git clone git@https://github.com/Daniel-Kav/Portfolio_website.git
...
Models and Assets used in the project can be found [here](https://drive.google.com/drive/u/0/folders/1iZjtnQP8INAcYXGLDkRxik0LZk2d-cmY)
